...
$Npreguntas=10;
$responderD='N';//Activar o desactivar que se responda todo como D con un S o N
$nombreBD='comipems';
				...
				<?php
					...
					function cadenaBin($Npreguntas,$rBinarias,$Nactual){
						...
						{					
							...
							<br/>
							";
							echo"<br/><br/><form action='salirC.php'><input class='btn' type='submit' value='Cerrar Sesión' /></form>";							
						}						
